...
#     db = SQL()
#     if db.connection:
#         db.create_user("Budi Santoso", "budi@gmail.com", "budi123", "08112222333", "member")
#         db.create_user("Ani Wijaya", "ani@gmail.com", "ani123", "08223333444", "member")
#         db.create_user("Cahya Pratama", "cahya@gmail.com", "cahya123", "08334444555", "admin")
