...
('Toyota', 2020, 'Avanza', 250000.00, 'toyota.jpg'),
('Honda', 2021, 'Civic', 350000.00, 'honda.jpg'),
('Suzuki', 2019, 'Ertiga', 220000.00, 'suzuki.jpg'),
('Mitsubishi', 2022, 'Xpander', 300000.00, 'mitsubishi.jpg'),
('Nissan', 2018, 'Livina', 230000.00, 'nissan.jpg');

INSERT INTO car (model_id, license_plate, availability) VALUES
(1, 'B 1234 ABC', 'available'),
(2, 'B 5678 DEF', 'not available'),
(2, 'B 9101 GHI', 'available'),
...
(3, 3, '2024-03-03', '2024-03-07', 'approved'),
...
(3, 4, '2024-03-08', '2024-03-12', 'rejected'),
...
(3, '2024-03-04', 1800000.00, 'E-Wallet', 'paid'),
(4, '2024-03-05', 2200000.00, 'Credit Card', 'unpaid'),
(5, '2024-03-06', 2500000.00, 'Cash', 'paid'),
(6, '2024-03-07', 1700000.00, 'E-Wallet', 'unpaid'),
(7, '2024-03-08', 2000000.00, 'Bank Transfer', 'paid'),
(8, '2024-03-09', 1900000.00, 'Credit Card', 'unpaid'),
(9, '2024-03-10', 2300000.00, 'E-Wallet', 'paid'),
(10, '2024-03-11', 2100000.00, 'Cash', 'paid');
